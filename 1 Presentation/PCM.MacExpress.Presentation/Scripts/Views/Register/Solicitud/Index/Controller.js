...
PCM.Reclamo.Presentacion.Register.Solicitud.Index.Controller = function () {
    var base = this;
    base.Ini = function () {
        'use strict'
        base.Control.SolicitudModel = PCM.Reclamo.Presentacion.Register.Solicitud.Models.Solicitud;
        ...
        base.Control.ValRegistro = new Gob.Pcm.UI.Web.Components.Validator({
            ...
            messages: PCM.Reclamo.Presentacion.Register.Solicitud.Resources,
    ...
    base.Control = {
        ...
        FormRegistro: function () { return $('#frmRegistrarSolicitud'); },
        SolicitudModel: null,
    ...
    base.Event = {
        BtnImprimirClick: function () {
            ...
            if (filtro.NroExpediente != null  ) {
                Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Register.Solicitud.Actions.DescargarDocumento, filtro);
            } 
        },
        ...
        CheckboxNombresClick: function () {
            ...
            base.Control.SlcTipoDocumento().append(new Option(PCM.Reclamo.Presentacion.Register.Solicitud.Resources.DNI, PCM.Reclamo.Presentacion.Register.Solicitud.Resources.DNI));
        ...
        CheckboxRazonSocialClick: function () {
            ...
            base.Control.SlcTipoDocumento().empty();
            base.Control.SlcTipoDocumento().append(new Option(PCM.Reclamo.Presentacion.Register.Solicitud.Resources.RUC, PCM.Reclamo.Presentacion.Register.Solicitud.Resources.RUC));
        ...
        CheckboxOtrosClick: function () {
            ...
            base.Control.TxtRazonSocial().prop("disabled", false);
            base.Control.SlcTipoDocumento().empty();
            if (base.Control.SolicitudModel != null && base.Control.SolicitudModel.ListaTipoDocumento != null) {                
                $.each(base.Control.SolicitudModel.ListaTipoDocumento, function (index, value) {
    ...
    base.Ajax = {
       ...
       {
           action: PCM.Reclamo.Presentacion.Register.Solicitud.Actions.BuscarPersona,
           autoSubmit: false,
           onSuccess: base.Event.AjaxBuscarPersonaSuccess
       }),
        AjaxBuscarUbigeoProvincia: new Gob.Pcm.UI.Web.Components.Ajax(
       {
           action: PCM.Reclamo.Presentacion.Register.Solicitud.Actions.BuscarUbigeo,
           autoSubmit: false,
        ...
        AjaxBuscarUbigeoDistrito: new Gob.Pcm.UI.Web.Components.Ajax(
       {
        ...
        {
            action: PCM.Reclamo.Presentacion.Register.Solicitud.Actions.Registrar,
            autoSubmit: false,
            onSuccess: base.Event.AjaxRegistrarSuccess
        }),
        AjaxSendEmail: new Gob.Pcm.UI.Web.Components.Ajax(
       {
           action: PCM.Reclamo.Presentacion.Register.Solicitud.Actions.EnviarCorreo,
           autoSubmit: false,
    ...
    base.Function = {
        ValidacionesExtras: function () {
            ...
            validationsExtra.push({
                Event: function () {
                    var isValido = true;
                    if (base.Control.SlcMedioEntrega().val() == "Email" && base.Control.TxtCorreoElectronico().val() == "") {
