...
PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Index.Controller = function () {
    var base = this;
    var options = {};
    var d = new Date();
    var mes = '';
    ...
    base.Ini = function () {
        'use strict'
        //base.Control.CongresoModel = PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Models.ConsultaEntrada;
        ...
        base.Control.BtnExportarExcelSeguimiento().on('click', base.Event.BtnExportarExcelSeguimientoClick);
        ...
        base.Control.SlcTipoExpediente().select2();
        options.ranges = {
            'Hoy': [moment(), moment()],
    ...
    base.Control = {
        ...
        SlcTipoExpediente: function () { return $('#slcTipoExpediente'); },
    ...
    base.Event = {
        BtnAdvanceFilterClick: function () {
            console.log(base.Control.DivAdvanceFilter().is(":visible"));
        ...
        BtnDescagarDocumentoClick: function () { 
                ...
                if (filtro.Anio != null && filtro.NroEmision!=null) {
                    Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.DescargarDocumento, filtro);
                }
                else {
        ...
        BtnExportExcelClick: function () {
            ...
            base.Control.Filtros.TipoExpediente = base.Control.SlcTipoExpediente().select2("val");
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.ExportarExcel, base.Control.Filtros);
        },
        BtnExportarExcelSeguimientoClick: function () {
            base.Control.Filtros.Dependencia = base.Control.SlcDependencia().select2("val");
            base.Control.Filtros.TipoDocumento = base.Control.SlcTipoDocumento().select2("val");
            base.Control.Filtros.Estado = base.Control.SlcEstado().select2("val");
            base.Control.Filtros.NroDocumento = base.Control.TxtNroDocumento().val();
            ...
            base.Control.Filtros.EstadoVencimiento = base.Control.SlcVencimiento().select2("val");
            base.Control.Filtros.TipoExpediente = base.Control.SlcTipoExpediente().select2("val");
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.ExportarExcelSeguimiento, base.Control.Filtros);
        },
        BtnExportPDFClick: function () {
            ...
            base.Control.Filtros.TipoExpediente = base.Control.SlcTipoExpediente().select2("val");
            base.Control.Filtros.EstadoVencimiento = base.Control.SlcVencimiento().select2("val");
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.ExportarPDF, base.Control.Filtros);
        },
        ...
        BtnLimpiarClick: function () {
            ...
            base.Control.SlcTipoExpediente().select2("val", "");
        ...
        BtnVerDetallleClick: function () { 
            ...
            if (filtro != null) {
                var url = PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.RecibidosIndex + filtro;                
        ...
        BtnVerSeguimientoClick: function () { 
                    ...
                    if (filtro != null) {
                        var url = PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.SeguimientoIndex + filtro;
                        base.Control.ModalVistaParcial().load(url, function (result) {
                            $('#registro').modal({ show: true, keyboard: false });                    
                        });
        ...
        BtnVerAnexoClick: function () { 
                    ...
                    if (filtro != null) {
                        var url = PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.DocumentoAnexoIndex + filtro;
                        base.Control.ModalVistaParcial().load(url, function (result) {
                            $('#registro').modal({ show: true, keyboard: false });                    
                        });
    ...
    base.Ajax = {
       ...
       {
           action: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.BuscarTipoDocumento,
           autoSubmit: false,
           onSuccess: base.Event.AjaxBuscarTipoDocumentoSuccess
       }),
        AjaxBuscarEmpleadoDependencia: new Gob.Pcm.UI.Web.Components.Ajax(
       {
           action: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.BuscarEmpleadoDependencia,
           autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'NumeroFila', 
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridItem,
                
                width: "5%"
            });
            columns.push({ 
                data: 'FechaEmision',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridFechaEmision, 
                width: "10%", 
            });

            columns.push({
                data: 'Remite',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridRemite,
                width: "16%",
            });
            columns.push({
                data: 'TipoDocumento',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridTipoDocumento,
            ...
            //columns.push({
            //    data: 'NroDocumento',
            //    title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridNroDocumento, 
            //    width:  "7%", 
            //});
           
            columns.push({
                data: 'Asunto',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridAsunto, 
                width: "20%",
                'class': 'justify',
            });            
            columns.push({
                data: 'Motivo',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridMotivo, 
                width: "7%"
            });             
            columns.push({
                data: 'NroExpediente',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridNroExpediente, 
                width: "7%"
            });
            columns.push({
                data: 'EstadoEmi',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridEstadoEmi,
                width: "7%"
            });
            columns.push({
                data: 'Destinatario',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridDestinatario,
                width: "16%"
            });
            columns.push({
                data: 'EstadoDes',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridEstadoDes,
                width: "7%"
            });

            columns.push({
                data: 'FechaRecepcion',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridFechaRecepcion,
                width: "10%",
            });

            columns.push({
                data: '',
                title: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Resources.GridFechaPlazo,
                width: '5%',
                mRender: function (data, type, full) {
            ...
            base.Control.GrdResultado = new Gob.Pcm.UI.Web.Components.Grid({
                ...
                columnDefs: [{ aTargets: [0], "orderable": false }, { aTargets: [1], "orderable": false }, { aTargets: [12], "orderable": false }],
                selectionRowsEvent: { on: 'click', callBack: base.Event.BtnGridSelectionRowClick },                
                proxy: {
                    url: PCM.Reclamo.Presentacion.Search.ConsultaEntrada.Actions.Buscar,
                    source: 'Result'
                },
