...
PCM.Reclamo.Presentacion.Search.ConsultaInterno.Index.Controller = function () {
    var base = this;
    var options = {};
    var d = new Date();
    var mes = '';
    ...
    base.Ini = function () {
        'use strict'
        //base.Control.CongresoModel = PCM.Reclamo.Presentacion.Search.ConsultaInterno.Models.ConsultaInterno;
    ...
    base.Event = {
        ...
        BtnDescagarDocumentoClick: function () { 
                ...
                if (filtro.Anio != null && filtro.NroEmision!=null) {
                    Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.DescargarDocumento, filtro);
                }
                else {
        ...
        BtnExportExcelClick: function () {
            ...
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.ExportarExcel, base.Control.Filtros);
        },
        BtnExportarExcelSeguimientoClick: function () {
            ...
            base.Control.Filtros.EstadoDestino = base.Control.SlcEstadoDestino().select2("val");
            base.Control.Filtros.EstadoVencimiento = base.Control.SlcVencimiento().select2("val");            
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.ExportarExcelSeguimiento, base.Control.Filtros);
        },
        BtnExportPDFClick: function () {
            ...
            base.Control.Filtros.EstadoDestino = base.Control.SlcEstadoDestino().select2("val");
            base.Control.Filtros.EstadoVencimiento = base.Control.SlcVencimiento().select2("val");
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.ExportarPDF, base.Control.Filtros);
        },
        ...
        BtnVerDetallleClick: function () { 
            ...
            if (filtro != null) {
                var url = PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.RecibidosIndex + filtro;                
        ...
        BtnVerSeguimientoClick: function () { 
                    ...
                    if (filtro != null) {
                        var url = PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.SeguimientoIndex + filtro;
                        base.Control.ModalVistaParcial().load(url, function (result) {
                            $('#registro').modal({ show: true, keyboard: false });                    
                        });
        ...
        BtnVerAnexoClick: function () { 
                    ...
                    if (filtro != null) {
                        var url = PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.DocumentoAnexoIndex + filtro;
                        base.Control.ModalVistaParcial().load(url, function (result) {
                            $('#registro').modal({ show: true, keyboard: false });                    
                        });
    ...
    base.Ajax = {
       ...
       {
           action: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.BuscarTipoDocumento,
           autoSubmit: false,
           onSuccess: base.Event.AjaxBuscarTipoDocumentoSuccess
       }),
        AjaxBuscarEmpleadoDependencia: new Gob.Pcm.UI.Web.Components.Ajax(
       {
           action: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.BuscarEmpleadoDependencia,
           autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'NumeroFila', 
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridItem,
                
                width: "5%"
            });
            columns.push({ 
                data: 'FechaEmision',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridFechaEmision, 
                width: "10%", 
            });

            columns.push({
                data: 'Remite',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridRemite,
                width: "16%",
            });
            columns.push({
                data: 'TipoDocumento',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridTipoDocumento,
            ...
            //columns.push({
            //    data: 'NroDocumento',
            //    title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridNroDocumento, 
            //    width:  "7%", 
            //});
           
            columns.push({
                data: 'Asunto',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridAsunto, 
                width: "20%",
                'class': 'justify',
            });            
            columns.push({
                data: 'Motivo',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridMotivo, 
                width: "7%"
            });             
            columns.push({
                data: 'NroExpediente',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridNroExpediente, 
                width: "7%"
            });
            columns.push({
                data: 'EstadoEmi',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridEstadoEmi,
                width: "7%"
            });
            columns.push({
                data: 'Destinatario',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridDestinatario,
                width: "16%"
            });
            columns.push({
                data: 'EstadoDes',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridEstadoDes,
                width: "7%"
            });

            columns.push({
                data: 'FechaRecepcion',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridFechaRecepcion,
                width: "10%",
            });

            columns.push({
                data: '',
                title: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Resources.GridFechaPlazo,
                width: '5%',
                mRender: function (data, type, full) {
            ...
            base.Control.GrdResultado = new Gob.Pcm.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: PCM.Reclamo.Presentacion.Search.ConsultaInterno.Actions.Buscar,
                    source: 'Result'
                },
