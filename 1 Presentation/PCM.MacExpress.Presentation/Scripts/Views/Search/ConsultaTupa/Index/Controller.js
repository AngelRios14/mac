...
PCM.Reclamo.Presentacion.Search.ConsultaTupa.Index.Controller = function () {
    var base = this;
    var options = {};
    var d = new Date();
    var mes = '';
    ...
    base.Ini = function () {
        'use strict'
        //base.Control.CongresoModel = PCM.Reclamo.Presentacion.Search.ConsultaTupa.Models.ConsultaTupa;
    ...
    base.Event = {
        ...
        BtnDescagarDocumentoClick: function () { 
                ...
                if (filtro.Anio != null && filtro.NroEmision!=null) {
                    Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.DescargarDocumento, filtro);
                }
                else {
        ...
        BtnExportExcelClick: function () {
            ...
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.ExportarExcel, base.Control.Filtros);
        },
        BtnExportPDFClick: function () {
            ...
            base.Control.Filtros.EstadoDestino = base.Control.SlcEstadoDestino().select2("val");
            base.Control.Filtros.EstadoVencimiento = base.Control.SlcVencimiento().select2("val");
            Gob.Pe.UI.Web.Components.Util.RedirectPost(PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.ExportarPDF, base.Control.Filtros);
        },
        ...
        BtnVerDetallleClick: function () { 
            ...
            if (filtro != null) {
                var url = PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.RecibidosIndex + filtro;                
        ...
        BtnVerSeguimientoClick: function () { 
                    ...
                    if (filtro != null) {
                        var url = PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.SeguimientoIndex + filtro;
                        base.Control.ModalVistaParcial().load(url, function (result) {
                            $('#registro').modal({ show: true, keyboard: false });                    
                        });
        ...
        BtnVerAnexoClick: function () { 
                    ...
                    if (filtro != null) {
                        var url = PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.DocumentoAnexoIndex + filtro;
                        base.Control.ModalVistaParcial().load(url, function (result) {
                            $('#registro').modal({ show: true, keyboard: false });                    
                        });
    ...
    base.Ajax = {
       ...
       {
           action: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.BuscarTipoDocumento,
           autoSubmit: false,
           onSuccess: base.Event.AjaxBuscarTipoDocumentoSuccess
       }),
        AjaxBuscarEmpleadoDependencia: new Gob.Pcm.UI.Web.Components.Ajax(
       {
           action: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.BuscarEmpleadoDependencia,
           autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'NumeroFila', 
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridItem,
                
                width: "5%"
            });
            columns.push({ 
                data: 'FechaEmision',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridFechaEmision, 
                width: "10%", 
            });

            columns.push({
                data: 'Remite',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridRemite,
                width: "16%",
            });
            columns.push({
                data: 'TipoDocumento',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridTipoDocumento,
            ...
            //columns.push({
            //    data: 'NroDocumento',
            //    title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridNroDocumento, 
            //    width:  "7%", 
            //});
            
            columns.push({
                data: 'Asunto',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridAsunto, 
                width: "20%",
                'class': 'justify',
            });            
            columns.push({
                data: 'Motivo',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridMotivo, 
                width: "12%"
            });             
            columns.push({
                data: 'NroExpediente',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridNroExpediente, 
                width: "7%"
            });
            columns.push({
                data: 'EstadoEmi',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridEstadoEmi,
                width: "7%"
            });
            columns.push({
                data: 'Destinatario',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridDestinatario,
                width: "16%"
            });
            columns.push({
                data: 'EstadoDes',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridEstadoDes,
                width: "7%"
            });

            columns.push({
                data: 'FechaRecepcion',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridFechaRecepcion,
                width: "10%",
            });

            columns.push({
                data: '',
                title: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Resources.GridFechaPlazo,
                width: '5%',
                mRender: function (data, type, full) {
            ...
            base.Control.GrdResultado = new Gob.Pcm.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: PCM.Reclamo.Presentacion.Search.ConsultaTupa.Actions.Buscar,
                    source: 'Result'
                },
